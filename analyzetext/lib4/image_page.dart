...
class _CropPageState extends State<CropPage> with SingleTickerProviderStateMixin{
  ...
  _requestYandex(String folderId ){
  ...
  _postImageYandex(frame, String base64Image) async{
    ...
    Response response=await dio.post(tokenUrl);
    String accessToken =  response.data['access_token'].toString();
    String IAM_TOKEN = "t1.9euelZqNzcnIxorGlMqczZqJnZqLmO3rnpWakJmbx5OJmo7GyozMy8yOjozl8_dYHjxr-e9dWQxg_d3z9xhNOWv5711ZDGD9.KheksNaCFVUvVF6PEvRJ5ejNTvhyeaSkzLS26Twg-WQtahHj0cHcH-ZgodO68-h1r8bJjVWj0mm_vzFCWf9PCQ";
